...
@interface ReadFrame : NSObject<IStateChangeListener,ILayoutEventListener, IDocEventListener,UIPopoverControllerDelegate,  IRotationEventListener, IGestureEventListener, IToolEventListener, IAnnotEventListener, ISearchEventListener>
{
    MyPageView* testPageView;
}
